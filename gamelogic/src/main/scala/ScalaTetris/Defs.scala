...
object BlockType extends Enumeration("<I>","<S>","<J>","<Z>","<L>","<O>","<T>") {
  ...
  // Allows conversion from a PieceType to BlockType
...
object Direction extends Enumeration("North", "South", "East", "West") {
  ...
  /** Extend the default enumeration to allow rotation operations */
  ...
  /** Translate a direction into a unit position shift */
